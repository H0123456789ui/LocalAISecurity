📝 项目初衷与开源声明
大家好，这是我独立开发的本地双 AI 安全防护工具，选择开源，是因为我对当下杀毒软件的现状有一些自己的想法：
如今市面上的安全工具，大多被广告、弹窗、后台推送和商业利益裹挟，不仅占用大量系统资源、拖慢电脑，甚至会过度收集用户数据，违背了 “安全防护” 的初衷。
我开发这个工具的核心目标，就是打造一款零广告、零数据上传、纯本地运行的安全软件：
所有 AI 推理、病毒检测、磁盘清理逻辑，都在你的电脑本地完成，不会向任何服务器上传用户隐私数据，真正做到 “隐私安全，由自己掌控”。
我深知开源会带来挑战：公开的代码可能被别有用心的人研究，甚至被用来针对性攻击。但我更相信开源社区的力量，相信更多技术大神的参与，能让这个工具变得更完善、更强大。
我把它开源出来，不是为了炫耀，而是希望大家一起：
优化双 AI 引擎的检测能力，让它能识别更多新型威胁；
强化本地防护逻辑，堵住可能被利用的漏洞；
剔除一切不必要的后台行为，守住 “纯本地、无广告、不收集数据” 的底线。
如果你也认同这份初心，欢迎一起贡献代码、提交 Issue、分享想法，让我们一起做一款真正为用户着想的安全工具。
